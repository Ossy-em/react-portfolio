  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        >
          <h3 className="text-2xl md:text-4xl font-semibold text-gray-900 max-w-xs">{project.title}</h3>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {project.technologies.map((tech, i) => (
              <motion.span 
                key={i} 
                className="px-3 py-1.5 bg-gray-100 border border-gray-300 rounded-full text-xs font-medium"
